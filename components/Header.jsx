...
const Header = () => {
    return (
        <div className="max-w-7xl px-4 sm:px-6 md:px-8 flex items-center justify-center sm:gap-16 shadow-2xl my-5 rounded-lg py-3 w-11/12 sm:w-[57%] fixed left-1/2 -translate-x-1/2 backdrop-blur-md bg-white/30 border border-white/20 z-10 dark:bg-zinc-900/30 dark:border-white/10 dark:backdrop-blur-md ">
            <NavigationMenu>
